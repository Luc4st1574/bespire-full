...
export default function DocumentsPage() {
    ...
    if (!isClient) {
        return <DashboardLayout><div className="p-8 text-center text-gray-500">Loading Documents...</div></DashboardLayout>;
    }
        ...
        <PermissionGuard required={PERMISSIONS.VIEW_FILES}>
            <DashboardLayout>
                <FileManagerMain
                    ...
                    filterMessage="Showing only documents"
